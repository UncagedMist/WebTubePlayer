package kk.techbytecare.webtubeplayer.Helper;
...
import kk.techbytecare.webtubeplayer.MainActivity;
import kk.techbytecare.webtubeplayer.R;
import kk.techbytecare.webtubeplayer.Remote.NotificationCloser;
...
public class BackgroundPlayHelper {
    ...
    public void showBackgroundPlaybackNotification() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .addAction(R.drawable.pause, "PAUSE", NotificationCloser.getDismissIntent(NOTIFICATION_ID, context))
